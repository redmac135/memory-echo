...
export default function AudioCapture({capturing, audioEncoded, setAudioEncoded, setEmotions}: {capturing: boolean, audioEncoded: string, setAudioEncoded: any, setEmotions: any}) {
    ...
    return (
        <AudioAnalysis setEmotions={setEmotions} audioEncoded={audioEncoded} capturing={capturing} />
    )
}